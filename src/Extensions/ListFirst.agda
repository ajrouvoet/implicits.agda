...
find P dec (x ∷ v) | no ¬px | yes firstv = yes (, there x (proj₂ firstv))
find P dec (x ∷ v) | no ¬px | no ¬firstv = no $ helper ¬px ¬firstv
  where
    ...
    helper ¬px ¬firstv (u  , there ._ firstv) = ¬firstv (u , firstv)
